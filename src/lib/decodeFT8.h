//--------------------------------------------------------------------------------------------------
// decodeFT8 FT8 decoder   (HEADER CLASS)
...
decodeFT8::decodeFT8(){
   ...
   sr=4000;
   TRACE=0x00;
   (this->TRACE>=0x01 ? fprintf(stderr,"%s::decodeFT8() Initialization completed tracelevel(%d)\n",PROGRAMID,this->TRACE) : _NOP);

}
//---------------------------------------------------------------------------------------------------
// setchangeSNR CLASS Implementation
//--------------------------------------------------------------------------------------------------
void decodeFT8::setchangeSNR(CALLBACK c) {
...
//--------------------------------------------------------------------------------------------------
void decodeFT8::setFrequency(float f) {
...
// --- format command
   ...
   sprintf(command,"sudo rtl_fm -M %s -f %s -s %d  -E direct | decodeFT8",MODE,FREQ,sr);
...
//--------------------------------------------------------------------------------------------------
int decodeFT8::readpipe(char* buffer,int len) {
