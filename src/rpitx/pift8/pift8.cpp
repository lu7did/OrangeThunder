...
#include "/home/pi/ft8_lib/ft8/pack.h"
...
int main(int argc, char **argv) {
    ...
    float frequency=14074000.0; // modified 
    float ppm=1000;
    ...
    fskburst* fsk=new fskburst(frequency+offset, 6.25, Deviation, 14, FifoSize,Upsample,RampRatio);
    if(ppm!=1000)
